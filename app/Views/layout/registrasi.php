                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <?= form_open(base_url('auth/addUser')) ?>
                                    <div class="form-group">
                                        <label><strong>Nama user</strong></label>
                                        <input type="text" name="nama_user" class="form-control" placeholder="Nama User" value="<?= old('nama_user') ?>" />
                                    ...
                                    <div class="new-account mt-3">
                                        <p>
                                            ...
                                            <a class="text-primary" href="<?= base_url('/') ?>">Sign in</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
