    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= base_url('/arsip/add') ?>">Tambah Arsip</a></li>
            </ol>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="no_arsip" value="<?= $no_arsip ?>" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="deskripsi" class="form-control" id="" rows="4"></textarea>
                            <div class="text-danger">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-dark">File Arsip</label>
                        <div class="col-sm-10">
